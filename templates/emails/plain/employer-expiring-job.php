...
if ( $expiring_today ) {
	printf( esc_html__( 'The following event listing is expiring today from %s (%s).', 'wp-event-manager' ), esc_html( get_bloginfo( 'name' ) ), esc_url( home_url() ) );
} else {
	printf( esc_html__( 'The following event listing is expiring soon from %s (%s).', 'wp-event-manager' ), esc_html( get_bloginfo( 'name' ) ), esc_url( home_url() ) );
}
printf( ' ' . esc_html__( 'Visit the event listing dashboard (%s) to manage the listing.', 'wp-event-manager' ), esc_url( event_manager_get_permalink( 'event_dashboard' ) ) );
