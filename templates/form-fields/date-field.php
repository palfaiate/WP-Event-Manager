<?php
/**
 * Shows a datepicker field on event listing forms.
 *
 * This template can be overridden by copying it to yourtheme/event_manager/form-fields/date-field.php.
 *
