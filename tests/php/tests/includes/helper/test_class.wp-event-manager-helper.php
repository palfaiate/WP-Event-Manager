 ...
 * @group helper-base
 */
class WP_Test_WP_event_Manager_Helper extends WPJM_Helper_Base_Test {
	/**
	 * Tests the WP_event_Manager_Helper::instance() always returns the same `WP_event_Manager_Helper` instance.
	 *
	 * @since 1.29.0
	 * @covers WP_event_Manager_Helper::instance
	 */
	public function test_wp_event_manager_instance() {
		$instance = WP_event_Manager_Helper::instance();
		// check the class.
		$this->assertInstanceOf( 'WP_event_Manager_Helper', $instance, 'event Manager Helper object is instance of WP_event_Manager_Helper class' );

		// check it always returns the same object.
		$this->assertSame( WP_event_Manager_Helper::instance(), $instance, 'WP_event_Manager_Helper::instance() must always return the same object' );
	}

	/**
	 * @since 1.29.0
	 * @covers WP_event_Manager_Helper::admin_init
	 * @requires PHP 5.3.0
	 */
	public function test_admin_init_no_dismiss() {
		$instance     = $this->getMockHelper();
		$product_slug = 'test';
		$default      = WP_event_Manager_Helper_Options::get( $product_slug, 'hide_key_notice', null );
		$this->assertNull( $default );
		$_GET['_wpjm_nonce'] = wp_create_nonce( 'dismiss-wpjm-licence-notice' );
		unset( $_GET['dismiss-wpjm-licence-notice'] );
		$instance->admin_init();
		$key_notice_status = WP_event_Manager_Helper_Options::get( $product_slug, 'hide_key_notice', null );
	...
	/**
	 * @since 1.29.0
	 * @covers WP_event_Manager_Helper::has_licenced_products
	 * @covers WP_event_Manager_Helper::get_plugin_version
	 * @covers WP_event_Manager_Helper::get_plugin_licence
	 * @requires PHP 5.3.0
	 */
	...
	public function test_check_for_updates_no_license() {
		...
		WP_event_Manager_Helper_Options::delete( 'test', 'licence_key' );
		WP_event_Manager_Helper_Options::delete( 'test', 'email' );
	...
	/**
	 * @since 1.29.0
	 * @covers WP_event_Manager_Helper::plugin_activated
	 * @requires PHP 5.3.0
	 */
	public function test_plugin_activated_actual_plugin() {
		...
		$this->assertTrue( WP_event_Manager_Helper_Options::get( $product_slug, 'hide_key_notice', null ) );
		$instance->plugin_activated( 'test/test.php' );
		$this->assertNull( WP_event_Manager_Helper_Options::get( $product_slug, 'hide_key_notice', null ) );
	}
	...
	/**
	 * @since 1.29.0
	 * @covers WP_event_Manager_Helper::plugin_deactivated
	 * @covers WP_event_Manager_Helper::deactivate_licence
	 * @requires PHP 5.3.0
	 */
	public function test_plugin_deactivated_actual_plugin() {
		...
		$product_slug = 'test';
		WP_event_Manager_Helper_Options::update( $product_slug, 'hide_key_notice', true );
		$this->assertNotEmpty( WP_event_Manager_Helper_Options::get( $product_slug, 'licence_key', null ) );
		$this->assertNotEmpty( WP_event_Manager_Helper_Options::get( $product_slug, 'email', null ) );
		$instance->plugin_deactivated( 'test/test.php' );
		$this->assertEmpty( WP_event_Manager_Helper_Options::get( $product_slug, 'licence_key', null ) );
		$this->assertEmpty( WP_event_Manager_Helper_Options::get( $product_slug, 'email', null ) );
	}

	/**
	 * @since 1.29.0
	 * @covers WP_event_Manager_Helper::plugins_api
	 * @requires PHP 5.3.0
	 */
	...
	/**
	 * @since 1.29.0
	 * @covers WP_event_Manager_Helper::plugin_links
	 * @requires PHP 5.3.0
	 */
	...
	/**
	 * @since 1.29.0
	 * @covers WP_event_Manager_Helper::is_product_installed
	 * @requires PHP 5.3.0
	 */
	 ...
	 * @since 1.29.0
	 * @covers WP_event_Manager_Helper::has_licenced_products
	 * @covers WP_event_Manager_Helper::get_plugin_info
	 * @requires PHP 5.3.0
	 */
	...
	public function test_get_plugin_license_valid() {
		WP_event_Manager_Helper_Options::update( 'rhino', 'licence_key', '1234' );
		WP_event_Manager_Helper_Options::update( 'rhino', 'email', 'test@local.dev' );
		WP_event_Manager_Helper_Options::update( 'rhino', 'errors', null );
		$instance = new WP_event_Manager_Helper();
		$result   = $instance->get_plugin_licence( 'rhino' );
		WP_event_Manager_Helper_Options::delete( 'rhino', 'licence_key' );
		WP_event_Manager_Helper_Options::delete( 'rhino', 'email' );
		WP_event_Manager_Helper_Options::delete( 'rhino', 'errors' );
		$expected = [
			'licence_key' => '1234',
	...
	/**
	 * @since 1.29.0
	 * @covers WP_event_Manager_Helper::extra_headers
	 */
